...
class MuZeroResidualNetwork(AbstractNetwork):
    ...
    def representation(self, observation):
        ...
        return self._extracted_from_dynamics_5(encoded_state)
    ...
    def dynamics(self, encoded_state, action):
        ...
        next_encoded_state_normalized = self._extracted_from_dynamics_5(next_encoded_state)

        return next_encoded_state_normalized, reward

    # TODO Rename this here and in `representation` and `dynamics`
    def _extracted_from_dynamics_5(self, arg0):
...
def support_to_scalar(logits, support_size):
    ...
    support = torch.tensor(list(range(-support_size, support_size + 1))).expand(probabilities.shape).float().to(device=probabilities.device)
